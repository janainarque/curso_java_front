...
function classificacaoImc(imc){
    const classificacao = ['Abaixo do peso', 'Peso normal', 'Sobrepeso', 'Obesidade grau I', 'Obsedidade grau II', 'Obsedidade grau III'];
...
function inserirResultado(msg, valido){
    ...
    if(valido == true){
        document.getElementById('resultado').style.backgroud = '#198754'
    }else{
